...
import NoImageSelected from '../../assets/react.svg'
...
function EditBook() {
        ...
        try{
            ...
            const response = await fetch("http://localhost:8000/api/books",{
               ...
               if(response.ok){
                ...
                console.log("Failed out submit data.");
               }
  ...
  return (
    <div>
      <h1>Edit Book</h1>
      <p>This page includes a form for updating book details, with fields for title, author, category, description, and thumbnail.</p>
